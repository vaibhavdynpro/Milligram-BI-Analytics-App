...
var sect_count = $("#sect_count_element").val();
var sub_sect_count = JSON.parse($("#countsArray").val());
$("#countsArray").val(JSON.stringify(sub_sect_count));
    ...
    $(document).on('click',"button[data-card-action='remove']",function(e){
      var sectionId_rem = $(this).attr("sectionId_remove");
      var phmId_remove = $(this).attr("phmId_remove");
      ...
      .on('click', '#ok', function(e) {
        ...
        $.ajax({
          type:'POST',
          url:'/phm/removeSection',
          data:{sectionId:sectionId_rem,phm_id:phmId_remove},
    ...
    //   var phmId_remove = $(this).attr("phmId_remove");
    //   var sub_sectionid_sect_id = $(this).attr("sub_sectionid_sect_id");
    //   console.log("test=>");
    //   console.log(sub_sectionid_sect_id);
    ...
    //     $.ajax({
    //       type:'POST',
    //       url:'/phm/removeSubSection',
    //       data:{sectionId:sub_sectionid_sect_id,phm_id:phmId_remove,subSectionId:sub_sectionId_subsect_rem},
    //       success:function(data){
    //          console.log(data);
    //          location.reload();
    //       }
    ...
    $(document).on('click',"button[data-card-subsection='remove']",function(e){
    ...
    $(document).on('click',"a[data-action='remove-old-section']",function(e){
      var url=$(this).attr("href");
      var section_no=$(this).attr("data-id");
      ...
      .on('click', '#ok', function(f) {
        //e.run();
        console.log(url);
        localStorage.setItem("sect_id", section_no);
        window.location.href =url;
       // return true;
      }).on('click', '#cancel', function(g) {
