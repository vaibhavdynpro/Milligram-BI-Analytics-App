...
class PatientSummary_Quaterly extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'PatientSummary_Quaterly:cron';
    ...
    public function handle()
    {
        ...
        $ScheduleData=\DB::table('patient_summary_report')->select('ps_report_id')->where(['is_active' => 1,'frequency' => 4,'status' => 0])
        ->get();
