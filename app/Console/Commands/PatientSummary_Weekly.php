...
class PatientSummary_Weekly extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'PatientSummary_Weekly:cron';
    ...
    public function handle()
    {
        ...
        $ScheduleData=\DB::table('patient_summary_report')->select('ps_report_id')->where(['is_active' => 1,'frequency' => 2,'status' => 0])
        ->get();
