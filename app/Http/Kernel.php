...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'looker' => 'App\Http\Middleware\Looker',
        'matillion' => 'App\Http\Middleware\Matillion',
        'roles' => 'App\Http\Middleware\Roles',
        'clients' => 'App\Http\Middleware\Clients',
        'phm' => 'App\Http\Middleware\Phm',
        'log.route' => \App\Http\Middleware\LogRoute::class,
        'EventLogRoute' => \App\Http\Middleware\EventLogRoute::class,
