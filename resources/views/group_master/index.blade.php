    ...
    background-color: white;">
					<div class="row">
					  ...
					  @if ($accessData[0]->group_add == 1)
						  <div class="col-sm-4">
						  <a href="/group_master/add" class="btn btn-primary float-sm-right" >Create</a>
						  </div>
					  @endif
					</div>
				</div>
				...
				@endphp
					...
					<tr>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<a href="group_master/edit/{{ \app\Libraries\Helpers::encrypt_decrypt($grp->group_id, 'encrypt') }}/{{ \app\Libraries\Helpers::encrypt_decrypt($grp->role_id, 'encrypt') }}" class=" badge btn btn-light" ><i class="fas fa-edit"></i> </a>
							</div>
							@endif
							@if ($accessData[0]->group_delete == 1)
							<div class="col-md-8">
							<form action="{{ route('deleteGroupMaster',[$grp->group_id,$grp->role_id]) }}" method="post">
							@csrf
