      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-md-7 resend-frm">
            ...
            @endif
              <div id="SignupForm">
              <form  role="form" method="POST" action="" id="ResendForm">
              		@csrf
                  <div class="form-group last mb-3">
                    ...
                    <input type="hidden" class="form-control" placeholder="Email" id="email" name="validateemail" value="{{$email_id}}">
              ...
              <form action="{{ route('updateotp',[Request::segment(2)]) }}" method="post">
                   ...
                   <input type="hidden" name="email" value="{{ \app\Libraries\Helpers::encrypt_decrypt(Request::segment(2), 'decrypt') }}">
				           <button class="resend-btn btn btn-link" type="submit">Resend-OTP</button>
			 </form> 
          </div>
        </div>
      </div>
